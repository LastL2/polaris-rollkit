...
func (p *Polaris) Build(app CosmosApp, ek EVMKeeper, allowedValMsgs map[string]sdk.Msg, hook chain.PostBlockHookFn) error {
	...
	p.WrappedBlockchain = chain.New(p.Blockchain(), app, hook)
